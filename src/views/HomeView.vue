<template>
  <main class="relative z-10 w-full overflow-x-clip">
    <section class="flex min-h-[100dvh] w-full flex-col items-center justify-center px-4 py-12 sm:px-6 md:px-12">
