  ...
  <div
    ...
    <div
      ...
      <button @click.stop="deleteCity"
        class="pointer-events-auto flex items-center gap-3 hover:opacity-50 transition-opacity uppercase tracking-[0.3em] text-xs font-bold mixes-blend-difference mt-12 mb-12">
        <span>Remove</span>
